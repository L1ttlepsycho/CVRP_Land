...
class PPO:
    ...
    def rollout(self, problem, T, val_m, stall_limit, batch, record = False, show_bar = False):
        ...
        obj, context = problem.get_costs(batch_aug_same, solutions, get_context = True, check_full_feasibility = False)
    ...
    def start_inference(self, problem, val_dataset, tb_logger):
        if self.opts.distributed:            
            ...
            score_list,time_list=validate(0, problem, self, val_dataset, tb_logger, distributed = False)
