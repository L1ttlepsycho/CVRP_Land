...
trainer_params = {
    ...
    'model_load': {
        ...
        'path': './result/cvrp100_200_5000steps',  # directory path of pre-trained model and log files saved.
...
meta_params = {
    ...
    # maml
    'meta_method': 'fomaml',  # choose from ['maml', 'fomaml', 'maml_fomaml', 'reptile']
    # size_distribution
