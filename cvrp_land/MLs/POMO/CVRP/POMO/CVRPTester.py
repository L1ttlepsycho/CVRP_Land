...
class CVRPTester:
    ...
    def run(self):
        ...
        print(">> Evaluation on {} finished within {:.2f}s".format(self.tester_params['test_set_path'], cal_time))

        # save results to file
        if not os.path.isdir('../../../../../results/mls/pomo/'):
            os.mkdir('../../../../../results/mls/pomo/')
        with open('../../../../../results/mls/pomo/'+os.path.split(self.tester_params['test_set_path'])[-1], 'wb') as f:
